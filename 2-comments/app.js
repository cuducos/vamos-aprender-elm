...
var _user$project$Main$viewComment = function (comment) {
	var commentClass = comment.saved ? '' : 'saving';
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class(commentClass)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(comment.author)
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_elm_lang$html$Html$text(comment.content)
			]));
};
var _user$project$Main$pluralize = F2(
	function (name, count) {
		return _elm_lang$core$Native_Utils.eq(count, 1) ? name : A2(_elm_lang$core$Basics_ops['++'], name, 's');
	});
var _user$project$Main$commentsUrl = 'https://vamosaprenderelm.herokuapp.com/api/comments/';
var _user$project$Main$updateCommentStatus = F2(
	function ($new, current) {
		return (_elm_lang$core$Native_Utils.eq($new.author, current.author) && _elm_lang$core$Native_Utils.eq($new.content, current.content)) ? _elm_lang$core$Native_Utils.update(
			current,
			{saved: true}) : current;
	});
var _user$project$Main$updateCommentsStatus = F2(
	function (newComment, comments) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Main$updateCommentStatus(newComment),
			comments);
	});
var _user$project$Main$Comment = F3(
	function (a, b, c) {
		return {author: a, content: b, saved: c};
	});
var _user$project$Main$resetForm = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			form: A3(_user$project$Main$Comment, '', '', false)
		});
};
var _user$project$Main$decodeComment = A2(
	...
	A3(
		...
		A3(
			...
			'author',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Comment))));
var _user$project$Main$decodeComments = A2(
	_elm_lang$core$Json_Decode_ops[':='],
	'comments',
	_elm_lang$core$Json_Decode$list(_user$project$Main$decodeComment));
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {comments: a, form: b, loaded: c};
	});
var _user$project$Main$initialModel = A3(
	_user$project$Main$Model,
	_elm_lang$core$Native_List.fromArray(
		[]),
	A3(_user$project$Main$Comment, '', '', false),
	false);
var _user$project$Main$CommentSaved = function (a) {
	return {ctor: 'CommentSaved', _0: a};
};
var _user$project$Main$ResetForm = {ctor: 'ResetForm'};
var _user$project$Main$ApiFail = function (a) {
	return {ctor: 'ApiFail', _0: a};
};
var _user$project$Main$saveComment = function (comment) {
	var json = _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'author',
				_1: _elm_lang$core$Json_Encode$string(comment.author)
			},
				{
				ctor: '_Tuple2',
				_0: 'content',
				_1: _elm_lang$core$Json_Encode$string(comment.content)
			}
			]));
	var data = _evancz$elm_http$Http$string(
		A2(_elm_lang$core$Json_Encode$encode, 0, json));
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$ApiFail,
		_user$project$Main$CommentSaved,
		A3(_evancz$elm_http$Http$post, _user$project$Main$decodeComment, _user$project$Main$commentsUrl, data));
};
		...
		switch (_p0.ctor) {
			case 'ApiSuccess':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{comments: _p0._0, loaded: true});
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ApiFail':
				var err = A2(_elm_lang$core$Debug$log, 'ApiFail', _p0._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ResetForm':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$resetForm(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PostComment':
				var content = _elm_lang$core$String$trim(model.form.content);
				var author = _elm_lang$core$String$trim(model.form.author);
				var newModel = (_elm_lang$core$String$isEmpty(author) && _elm_lang$core$String$isEmpty(content)) ? model : _elm_lang$core$Native_Utils.update(
					model,
					{
						comments: A2(
							_elm_lang$core$List$append,
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$resetForm(newModel),
					_1: _user$project$Main$saveComment(model.form)
				};
			case 'UpdateAuthor':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							form: A3(_user$project$Main$Comment, _p0._0, model.form.content, false)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateContent':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							form: A3(_user$project$Main$Comment, model.form.author, _p0._0, false)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var newComments = A2(_user$project$Main$updateCommentsStatus, _p0._0, model.comments);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$ApiSuccess = function (a) {
	return {ctor: 'ApiSuccess', _0: a};
};
var _user$project$Main$loadComments = A3(
	_elm_lang$core$Task$perform,
	_user$project$Main$ApiFail,
	_user$project$Main$ApiSuccess,
	A2(_evancz$elm_http$Http$get, _user$project$Main$decodeComments, _user$project$Main$commentsUrl));
...
var _user$project$Main$view = function (model) {
	if (model.loaded) {
		var count = _elm_lang$core$List$length(model.comments);
		var title = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(count),
			A2(_user$project$Main$pluralize, ' Comentário', count));
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$List$map, _user$project$Main$viewComment, model.comments)),
					A2(
					_elm_lang$html$Html$form,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onSubmit(_user$project$Main$PostComment)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateAuthor),
											_elm_lang$html$Html_Attributes$value(model.form.author)
										]),
									_elm_lang$core$Native_List.fromArray(
										[]))
								])),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Comentário:')
										])),
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('form-control'),
											_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateContent),
											_elm_lang$html$Html_Attributes$value(model.form.content)
										]),
									_elm_lang$core$Native_List.fromArray(
										[]))
								])),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onClick(_user$project$Main$ResetForm),
									_elm_lang$html$Html_Attributes$class('btn btn-default')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Cancelar')
								])),
							A2(
							_elm_lang$html$Html$button,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Enviar')
								]))
						]))
				]));
	} else {
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _user$project$Main$loadComments},
